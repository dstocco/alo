...
function(depends_on_fairmq target)
    # target depends on all argsn
    get_target_property(a o2::${target} INTERFACE_LINK_LIBRARIES)
    if (a)
        set(tmp ${a})
...
if (O2)
    ...
    if (EXISTS ${O2}/lib AND EXISTS ${O2}/include)

        foreach (t Framework MCHMappingImpl3 MCHMappingInterface MCHMappingSegContour MCHMappingSegContour3 MCHContour)
            if (NOT TARGET o2::${t})
        ...
        depends_on_fairmq(Framework FairMQ)
        depends_on_boost(Framework boost)
        depends_on_root(Framework Core)
